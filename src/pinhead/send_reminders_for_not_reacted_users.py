...
from .helpers.filter_finished_messages import filter_finished_messages
...
unreacted_finished_messages = filter_finished_messages(unreacted_bot_messages)

for message in unreacted_finished_messages:
